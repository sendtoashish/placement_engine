...
//    @Bean(name="entityManagerFactory")
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        try {
            ...
            localContainerEntityManagerFactoryBean.setPackagesToScan("placementenginejobposting.entity");
            localContainerEntityManagerFactoryBean.setPersistenceUnitName("placement_engine_jobposting");
